(function(global){
	...
	function createBlock(name, value, contents){
		...
		if (Array.isArray(contents)){
			item.appendChild(elem('div', {'class': 'container_blocks'}, contents.map(function(block){
	...
	function blockContents(block){
		var container_blocks = block.querySelector('.container_blocks');
		return container_blocks ? [].slice.call(container_blocks.children) : null;
	}
